...
<qgis maxScale="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" version="3.12.0-București" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyAlgorithm="0" minScale="100000000" simplifyLocal="1" readOnly="1" labelsEnabled="1" simplifyMaxScale="1">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{dca169a3-b5f7-4413-9723-8c7c7d0ca511}">
      <rule symbol="0" key="{5d17ca03-0b6a-45c6-bbea-096dbce673f7}" filter="( to_string(&quot;speed&quot;)) >= 0.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 1.000000" label="0 - 1  mph"/>
      <rule symbol="1" key="{de85bd52-a2e7-46a1-ae4a-814add51ee21}" filter="( to_string(&quot;speed&quot;)) > 1.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 4.000000" label="1 - 4 mph"/>
      <rule symbol="2" key="{951b9a12-b88a-43cb-887b-0e2eaa2aa14d}" filter="( to_string(&quot;speed&quot;)) >4.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 8.000000" label="4 - 8 mph"/>
      <rule symbol="3" key="{f73ebc86-ba9d-415a-8201-bcd3b2adb5fa}" filter="( to_string(&quot;speed&quot;)) > 8.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 13.000000" label="8 - 13 mph"/>
      <rule symbol="4" key="{02695bf1-4430-4066-8432-9097c8631cf8}" filter="( to_string(&quot;speed&quot;)) > 13.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 18.000000" label="13 - 18 mph"/>
      <rule symbol="5" key="{fa829be5-a76c-449e-a63e-ffcb11430412}" filter="( to_string(&quot;speed&quot;)) > 18.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 25.000000" label="18 - 25 mph"/>
      <rule symbol="6" key="{6637fa7b-2942-4c68-9150-62920e3bde58}" filter="( to_string(&quot;speed&quot;)) > 25.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 31.000000" label="25 - 31 mph"/>
      <rule symbol="7" key="{9f9f1537-9a31-410d-9315-799059c9fa02}" filter="( to_string(&quot;speed&quot;)) > 31.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 39.000000" label="31 - 39 mph"/>
      <rule symbol="8" key="{c9da698e-78d5-47d8-8da4-7384df2753d8}" filter="( to_string(&quot;speed&quot;)) > 39.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 47.000000" label="39 - 47 mph"/>
      <rule symbol="9" key="{39b42fb1-0e59-43b6-8b3b-f4b39aa28b36}" filter="( to_string(&quot;speed&quot;)) > 47.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 55.000000" label="47 - 55 mph"/>
      <rule symbol="10" key="{bee30c2d-c55e-4a50-9eb4-4c7c19831e14}" filter="( to_string(&quot;speed&quot;)) > 55.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 64.000000" label="55 - 64 mph"/>
      <rule symbol="11" key="{2605b9f9-9e81-4602-867c-1ffe9fad43b2}" filter="( to_string(&quot;speed&quot;)) > 64.000000 AND ( to_string(&quot;speed&quot;)) &lt;= 74.000000" label="64 - 74 mph"/>
      <rule symbol="12" key="{4c039144-1c36-4995-b309-a2925d8eb724}" filter="( to_string(&quot;speed&quot;)) > 74.000000" label="> 74 mph"/>
      <rule symbol="13" description="Unknown" key="{6a49a6b3-1742-4774-ab2c-b23e328b4e39}" filter="ELSE"/>
    </rules>
    <symbols>
    ...
    <settings calloutType="simple">
      ...
      <callout type="simple">
        <Option type="Map">
          ...
          <Option type="double" value="0.2" name="offsetFromAnchor"/>
